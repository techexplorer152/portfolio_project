...
const Raw_Data = [
    ...
    {
        img: Java_img,
        title: "Java from Scratch Course",
        Bio: "A comprehensive curriculum overview containing core syntax, architecture design principles, databases, and structural frameworks."
    }
];
